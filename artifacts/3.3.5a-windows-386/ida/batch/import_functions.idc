...
static import_functions() {
	...
	set_func_cmt(0x00465780, "void HMAC<SHA1>::Finish(SHA1::Digest& digest)", 0);
	...
	set_func_cmt(0x004668A0, "void HMAC<SHA1>::Prepare(const void* data, uint32_t bytes)", 0);
	...
	set_func_cmt(0x004D5EE0, "known names: CGObject_C__GetFacing, CGCamera__GetDefaultZoomMinDistance", 0);
	...
	set_func_cmt(0x00632970, "NetClient::HELDMESSAGE::~HELDMESSAGE", 0);
	...
	set_func_cmt(0x00633020, "invented name", 0);
	set_func_cmt(0x00633250, "invented name", 0);
	...
	set_func_cmt(0x008C52D0, "BattlenetLogin::NextSecurityState, FMOD::DSPResampler::addInput", 0);
	...
	set_func_cmt(0x008CFAA0, "FMOD::Memory_DefaultMalloc", 0);
	set_func_cmt(0x008CFAC0, "FMOD::Memory_DefaultRealloc", 0);
	set_func_cmt(0x008CFAE0, "FMOD::Memory_DefaultFree", 0);
	set_func_cmt(0x008D1010, "FMOD__SoundI__getPosition, FMOD__ChannelI__getUserData", 0);
	set_func_cmt(0x008D1120, "invented name", 0);
	set_func_cmt(0x008E18F0, "known names: FMOD::SoundI::getNumSubSounds, FMOD::DSPI::getNumParameters", 0);
	set_func_cmt(0x008E2F90, "FMOD__SoundI__setPosition, FMOD__ChannelI__setUserData", 0);
	set_func_cmt(0x008E4870, "FMOD::SoundGroupI::validate, FMOD::ChannelGroupI::validate", 0);
