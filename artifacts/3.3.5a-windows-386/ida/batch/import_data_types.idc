...
static import_data_types() {
	...
	apply_type(0x0084E400, "void __stdcall func(lua_State* L, lua_CFunction fn, int n)");
	...
	apply_type(0x00855740, "int32_t __stdcall func()");
	...
	apply_type(0x0085C520, "void __stdcall func(lua_State* L, Table* t, TValue* key)");
